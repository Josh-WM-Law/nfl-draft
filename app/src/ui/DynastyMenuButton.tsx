  ...
  return (
    <>
      <button
        ...
        className="fixed top-3 right-3 z-40 w-10 h-10 rounded-full bg-slate-900/90 hover:bg-slate-800 border border-slate-700 text-white flex items-center justify-center shadow-lg backdrop-blur"
      >
        <svg
          viewBox="0 0 20 20"
          fill="currentColor"
      ...
      {open && (
        <>
          ...
          />
          <div className="fixed top-14 right-3 z-50 w-56 rounded-xl bg-slate-900 border border-slate-800 shadow-2xl overflow-hidden">
